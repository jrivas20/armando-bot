...
const SEO_CLIENTS = {
  ...
  '6FdG0APBuZ81P8X2H4zc': {
    ...
    blogEnabled: false,
    apiKey: 'pit-77ba2ef0-8719-49a7-80a9-0182de4add1e',
  ...
  'Gc4sUcLiRI2edddJ5Lfl': {
    ...
    apiKey: 'pit-9432fc51-f2d0-42d0-8bc0-753b24c55d3e',
    brand: {
  ...
  'VWHZW08b0skUV7wcnG55': {
    ...
    apiKey: 'pit-f5315354-6368-4a3e-a0d7-dd59118c094c',
  ...
  'uSJLhp7BCFFgEYR64nyA': {
    name: 'JR Paver Sealing',
    domain: 'jrpaversealing.com',
    lang: 'en',
    industry: 'paver sealing, pressure washing, and exterior cleaning',
    blogEnabled: false,
    gbpEnabled: true,
    author: {
      name: 'JR',
      title: 'Owner, JR Paver Sealing And More',
      credentials: 'Paver sealing and pressure washing specialist serving Central Florida homeowners. Expert in driveway, pool deck, and patio restoration.',
      bio: 'JR built his business on one principle: protect what homeowners have worked hard to build. Every job is done right the first time — no shortcuts, no upsells you don\'t need.',
    },
    voice: 'Straight-talking, hardworking, and local. Talks like a guy who has sealed thousands of driveways and knows exactly what Florida sun and rain does to pavers. Practical advice, clear pricing, no fluff.',
    audience: 'Homeowners in Central Florida with pavers, driveways, pool decks, and patios that need sealing, cleaning, or restoration. They want it done right, affordable, and by someone local they can trust.',
    keywords: [
      'paver sealing Orlando', 'paver sealing Central Florida', 'driveway sealing Orlando',
      'paver cleaning Orlando', 'pressure washing Orlando', 'pool deck sealing Orlando',
      'patio cleaning Orlando FL', 'paver restoration Orlando', 'driveway cleaning near me',
      'pressure washing near me Orlando',
    ],
    topics: ['why seal your pavers every 2-3 years', 'paver sealing cost Orlando', 'best time to seal pavers in Florida', 'pressure washing vs soft washing driveways', 'how to restore faded pavers'],
    cta: 'Get a free quote at jrpaversealing.com or call (407) 409-9023',
    apiKey: 'pit-149bc336-c56a-4632-aba0-fb0c20d5e2f0',
    brand: { primary: '#1a1a2e', accent: '#f5a623', bg: '#ffffff' },
  },
  'OqnDdohCjhm3rUNFZUBv': {
    name: 'AV4 Water Damage',
    domain: 'av4waterdamage.com',
    lang: 'en',
    industry: 'water damage restoration and remediation',
    blogEnabled: false,
    gbpEnabled: true,
    author: {
      name: 'AV4 Team',
      title: 'Water Damage Restoration Specialists, AV4',
      credentials: 'Certified water damage restoration professionals serving Central Florida. IICRC-trained technicians available 24/7 for emergency water, flood, and mold remediation.',
      bio: 'AV4 Water Damage was built for the moments homeowners dread most. When water damage hits, speed is everything — AV4 responds fast, documents everything for insurance, and restores your property the right way.',
    },
    voice: 'Urgent, professional, and reassuring. Speaks to homeowners in crisis who need help NOW. Instills confidence that the problem will be handled correctly, fast, and documented for insurance. Clear, direct, and trustworthy.',
    audience: 'Homeowners and property managers in Central Florida dealing with water damage, flooding, burst pipes, roof leaks, or mold. They need emergency response, insurance documentation, and full restoration.',
    keywords: [
      'water damage restoration Orlando', 'water damage repair Orlando', 'flood damage restoration Central Florida',
      'emergency water damage Orlando', '24 hour water damage Orlando', 'mold remediation Orlando',
      'water damage company near me', 'burst pipe water damage Orlando', 'water extraction Orlando FL',
      'water damage insurance claim Orlando',
    ],
    topics: ['what to do first after water damage', 'how to file water damage insurance claim', 'signs of hidden water damage in your home', 'mold after water damage what to do', 'how fast does mold grow after water damage'],
    cta: 'Call AV4 Water Damage 24/7 for emergency response — av4waterdamage.com',
    apiKey: 'pit-ace8598d-8f29-4680-8f9a-f2a21b0da73f',
    brand: { primary: '#0a3d6b', accent: '#00aaff', bg: '#ffffff' },
  },
  'S8XzcEfRd6IMx4mvfnSf': {
    name: 'Take a Sushi',
    domain: 'takeasushi.com',
    lang: 'en',
    industry: 'sushi restaurant',
    blogEnabled: false,
    gbpEnabled: true,
    author: {
      name: 'Take a Sushi Team',
      title: 'Sushi Chefs & Owners, Take a Sushi',
      credentials: 'Fresh sushi crafted daily in Orlando. Family-owned sushi restaurant known for quality rolls, warm service, and a welcoming atmosphere.',
      bio: 'Take a Sushi was built on one idea: great sushi should feel like home. Every roll is made fresh, every guest is family, and every visit should leave you wanting to come back.',
    },
    voice: 'Warm, fresh, and inviting. Celebrates the craft of sushi and the joy of sharing a great meal. Approachable, friendly, and makes you hungry just reading it. Family-oriented with a passion for quality.',
    audience: 'Sushi lovers and families in Orlando looking for fresh, quality rolls in a welcoming environment. Date nights, family dinners, takeout orders, and anyone searching for sushi near me in Orlando.',
    keywords: [
      'sushi Orlando', 'sushi restaurant Orlando', 'best sushi Orlando FL',
      'sushi near me Orlando', 'fresh sushi Orlando', 'sushi rolls Orlando',
      'Japanese restaurant Orlando', 'sushi takeout Orlando', 'sushi delivery Orlando',
      'family sushi restaurant Orlando',
    ],
    topics: ['best sushi rolls to try in Orlando', 'why fresh sushi makes a difference', 'date night sushi ideas Orlando', 'sushi for the whole family', 'how sushi rolls are made fresh daily'],
    cta: 'Order online or visit us at takeasushi.com',
    apiKey: 'pit-6a8cdd08-489e-425a-99fd-0ce9f3f628cc',
    brand: { primary: '#016647', accent: '#d4567a', bg: '#ffffff' },
  },
  'BlyQAv719YyBg4TCPD0L': {
    name: 'Remedi Body & Skin',
    domain: 'remedibodyandskin.com',
    lang: 'en',
    industry: 'medical spa, body contouring, and skin care',
    blogEnabled: false,
    gbpEnabled: true,
    author: {
      name: 'Remedi Team',
      title: 'Aesthetic Specialists, Remedi Body & Skin',
      credentials: 'Licensed aesthetic professionals specializing in body contouring, skin rejuvenation, and non-invasive treatments in Central Florida.',
      bio: 'Remedi Body & Skin was created for people who want to look and feel their best without surgery. Every treatment is personalized, every result is real.',
    },
    voice: 'Confident, empowering, and results-focused. Speaks to people who invest in themselves. Warm but professional — makes clients feel seen and excited about their transformation. Celebrates real results.',
    audience: 'Men and women in Central Florida looking for non-invasive body contouring, skin treatments, facials, and aesthetic services. They want real results, a comfortable experience, and a team they can trust.',
    keywords: [
      'med spa Orlando', 'body contouring Orlando', 'skin care Orlando FL',
      'non-invasive body sculpting Orlando', 'facial treatments Orlando', 'skin rejuvenation Orlando',
      'body sculpting near me Orlando', 'aesthetic clinic Orlando', 'laser skin treatment Orlando',
      'medspa Central Florida',
    ],
    topics: ['best non-invasive body contouring treatments 2026', 'how to choose a med spa in Orlando', 'skin rejuvenation options for Florida skin', 'body sculpting results what to expect', 'facial treatments for glowing skin Orlando'],
    cta: 'Book your free consultation at remedibodyandskin.com',
    apiKey: 'pit-042facf3-8cb4-4d25-ae6a-8fcf6cee43a8',
    brand: { primary: '#2d2d2d', accent: '#c9a96e', bg: '#ffffff' },
  },
  'QWZPYWo1AgLpLjHTG6OA': {
    name: 'Tiger Tattoos',
    domain: 'tigertattooorlando.com',
    lang: 'en',
    industry: 'tattoo studio',
    blogEnabled: false,
    gbpEnabled: false, // TEMP: wrong Google account connected (Escobar Kitchen GMB) — reconnect correct GMB in Social Planner then re-enable
    author: {
      name: 'Tiger Tattoos Team',
      title: 'Professional Tattoo Artists, Tiger Tattoos',
      credentials: 'Experienced tattoo artists in Orlando specializing in custom designs, fine line, realism, traditional, and cover-up tattoos. Licensed and safety-certified studio.',
      bio: 'Tiger Tattoos is where Orlando comes for ink that lasts a lifetime. Every artist on the team brings their own style and precision — from first tattoos to full sleeves, every client leaves with something they are proud to wear.',
    },
    voice: 'Bold, artistic, and welcoming. Celebrates the craft of tattooing and the stories behind every piece. Makes first-timers feel comfortable and experienced collectors feel at home. Confident without being intimidating.',
    audience: 'Tattoo enthusiasts in Orlando from first-timers to collectors. People searching for custom tattoos, cover-ups, fine line work, or a specific style. They want a clean, professional studio with talented artists they can trust.',
    keywords: [
      'tattoo shop Orlando', 'tattoo studio Orlando', 'best tattoo artist Orlando',
      'custom tattoo Orlando', 'tattoo near me Orlando', 'fine line tattoo Orlando',
      'realism tattoo Orlando FL', 'cover up tattoo Orlando', 'tattoo parlor Orlando',
      'tattoo artist Central Florida',
    ],
    topics: ['how to choose the right tattoo artist in Orlando', 'tattoo aftercare tips for Florida heat', 'best tattoo styles trending in 2026', 'what to expect at your first tattoo appointment', 'cover up tattoo ideas that actually work'],
    cta: 'Book your tattoo consultation at tigertattooorlando.com',
    apiKey: 'pit-383ca695-ebef-4bd9-8b2a-af42e498a19e',
    brand: { primary: '#111111', accent: '#ff6b00', bg: '#ffffff' },
  },
  'd1VBgXk2TqHYwlTy85Pa': {
    name: 'SOCF Fitness',
    domain: 'socffitness.com',
    lang: 'en',
    industry: 'fitness gym and personal training',
    blogEnabled: false,
    gbpEnabled: true,
    author: {
      name: 'SOCF Fitness Team',
      title: 'Coaches & Trainers, SOCF Fitness',
      credentials: 'Certified fitness coaches and personal trainers in Central Florida. Specializing in strength training, functional fitness, weight loss, and community-driven workouts.',
      bio: 'SOCF Fitness was built for people who are serious about change. Not just a gym — a community that shows up for each other every single day. Real coaches, real results, real people.',
    },
    voice: 'Energetic, motivating, and community-first. Pushes people to show up and do the work. Celebrates every win, speaks to real people with real goals — not just athletes. Inclusive, tough-love, results-driven.',
    audience: 'Adults in Central Florida who want to get fit, lose weight, build strength, or find a fitness community. From beginners to athletes — people who want coaching, accountability, and real results.',
    keywords: [
      'gym Orlando', 'fitness gym Orlando', 'personal training Orlando',
      'CrossFit Orlando', 'functional fitness Orlando', 'strength training Orlando',
      'weight loss gym Orlando', 'fitness classes Orlando FL', 'gym near me Orlando',
      'personal trainer Central Florida',
    ],
    topics: ['how to start working out in Orlando', 'benefits of functional fitness training', 'personal training vs group classes which is right for you', 'how to lose weight with strength training', 'finding a fitness community in Orlando that actually works'],
    cta: 'Start your free trial at socffitness.com',
    apiKey: 'pit-46f4e2e5-ae76-44dd-9e04-7bd4fefd7adb',
    brand: { primary: '#1a1a1a', accent: '#e63946', bg: '#ffffff' },
  },
